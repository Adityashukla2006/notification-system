...
func TestMeEndpoint(t *testing.T) {
	...
	handler := Router(discardLogger(), fakePinger{}, fakePinger{}, keys, &fakeCreator{}, newFakeReader())
...
func TestMeRequiresAuth(t *testing.T) {
	handler := Router(discardLogger(), fakePinger{}, fakePinger{}, &fakeKeys{}, &fakeCreator{}, newFakeReader())
