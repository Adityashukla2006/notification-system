...
func TestMeEndpoint(t *testing.T) {
	...
	handler := Router(discardLogger(), fakePinger{}, fakePinger{}, keys, &fakeCreator{}, newFakeReader(), allowAllLimiter{})
...
func TestMeRequiresAuth(t *testing.T) {
	handler := Router(discardLogger(), fakePinger{}, fakePinger{}, &fakeKeys{}, &fakeCreator{}, newFakeReader(), allowAllLimiter{})
