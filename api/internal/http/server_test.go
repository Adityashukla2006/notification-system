...
func newTestServer() http.Handler {
	...
	return Router(logger, fakePinger{}, fakePinger{}, &fakeKeys{}, &fakeCreator{}, newFakeReader(), allowAllLimiter{})
}
...
func TestLiveness(t *testing.T) {
	...
	handler := Router(logger, down, down, &fakeKeys{}, &fakeCreator{}, newFakeReader(), allowAllLimiter{})
...
func TestReadiness(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			handler := Router(logger, tt.postgres, tt.redis, &fakeKeys{}, &fakeCreator{}, newFakeReader(), allowAllLimiter{})
